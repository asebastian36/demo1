...
@Component("credit")
public class CreditRiskFitnessFunction implements FitnessFunction {
    ...
    public CreditRiskFitnessFunction(BinaryToDecimalConverter binaryConverterService) {
     ...
     */
    public static Map<String, Object> getInterpretationDetails(String binary, BinaryToDecimalConverter converterService) {
