...
public class ChromosomeBasedFitnessStrategy implements FitnessEvaluationStrategy {
    ...
    public boolean supports(String functionType) {
        return "credit".equals(functionType) || "consumo".equals(functionType) || "farmacologia".equals(functionType) || "transporte".equals(functionType) || "netflix".equals(functionType);
    }
